...
public class CircularQueueTests {
	...
	public void enqueueDequeue100Elements_shouldWorkCorrectly() {
		...
		CircularQueue<Integer> queue = new CircularQueue<>(numberOfElements);
	...
	public void circularQueue_enqueueDequeueManyChunks_shouldWorkCorrectly() {
		...
		int chunks = 100;
		CircularQueue<Integer> queue = new CircularQueue<>(chunks);
	...
	public void enqueue500Elements_toArray_shouldWorkCorrectly() {
		...
		CircularQueue<Object> queue = new CircularQueue<>(array.length);
	...
	public void initialCapacity1_enqueueDequeue20Elements_shouldWorkCorrectly() {
		...
		CircularQueue<Integer> queue = new CircularQueue<>(initialCapacity + elementsCount);
