...
public class BinarySearchTreeTests {
	...
	public void testContainsMethod_shouldReturnTrue() {
		boolean contains = bst.contains(18);
		Assert.assertEquals(true, contains);
	}

	@Test
	public void testEachInOrderMethod_shouldReturnInOrder() {
		bst.eachInOrder(e -> System.out.print(" " + e));
	}
	...
	public void testSearch_CheckReturnedTreeStructure1() {
		...
		search.eachInOrder(e -> System.out.print("\n " + e));
